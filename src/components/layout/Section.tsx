    ...
    <Box id={id} component="section" sx={{ py: { xs: 8, md: 12 }, scrollMarginTop: 80 }}>
      <Container maxWidth={maxWidth}>
        <MotionBox
          ...
          // este stagger se aplica a título, subtítulo, divider y el bloque de contenido
          variants={{ show: { transition: { staggerChildren: reduce ? 0 : 0.08 } } }}
        >
          <MotionBox variants={fadeUp} component={Typography}
            variant="h4"
            fontWeight={800}
            textAlign="center"
            gutterBottom
          ...
          {subtitle && (
            <MotionBox variants={fadeUp}>
              <Typography variant="subtitle1" color="text.secondary" textAlign="center" sx={{ maxWidth: 640, mx: "auto", mb: 4 }}>
                {subtitle}
              </Typography>
            </MotionBox>
          )}
          ...
          {/* Contenido del section (fade-in suave) */}
          <MotionBox variants={fadeUp}>
            {children}
          </MotionBox>
        </MotionBox>
